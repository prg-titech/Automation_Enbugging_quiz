...
class Generatable():
    ...
    def is_end_point(self):
        """Returnes ture or false based on weather or not the arguments can be without containing jump to other rule."""
        pass
...
class Group(Generatable):
    ...
    # def is_end_point(self):
    #     print("Maybe not intending call is_end_point in Group")
    #     args = self.args
    #     for elem in args:
    #         if elem.is_end_point():
    #             return True
    #     return False
